...
export default class InstagramFeed extends BaseComponent {
	...
	onImgLoaded() {
		...
		setTimeout(this.props.updateComponentSize, 1000)
	}
	...
	animateContainers() {
		...
		TweenMax.fromTo(this.slides.back, 0.8, { x:this.panelSize[0]*2, transformOrigin:'100% 0%', force3D:true }, { x:-this.panelSize[0] - 2, transformOrigin:'100% 0%', force3D:true, ease:Expo.easeInOut })
